...
name := "spark-bigquery-ingestion"
organization := "br.com.bruno"
version := "0.1"
...
mainClass in assembly := Some("br.com.bruno.data.ingestion.Starter")

assemblyJarName in assembly := "igt_database.jar"